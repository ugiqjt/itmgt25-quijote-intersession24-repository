...
def savings(gross_pay, tax_rate, expenses):def savings(gross_pay, tax_rate, expenses):
    ...
    '''
    after_tax_pay = int(gross_pay) - (int(gross_pay) * float(tax_rate))
    take_home_pay = int(after_tax_pay) - int(expenses)
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    '''
    waste_jobs = int(total_material) - (int(num_jobs)*int(job_consumption))
    return f"{waste_jobs}{material_units}"
